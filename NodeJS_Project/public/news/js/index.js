...
$(function () {
    ...
    //页面滚动加载相关
    $(window).scroll(function () {  // 窗口滚动事件， 频繁触发的事件
        ...
        if ((canScrollHeight - nowScroll) < 100) {
            ...
            console.log("is_data_querying:",is_data_querying);
            // TODO 判断页数，去更新新闻数据
    ...
    $.get("/news_list", params, function (resp) {
        ...
        if (resp) {
            ...
            for (var i=0;i<resp.newsList.length;i++) {
                ...
                content += '<div class="time fl">' + dateFormat(news.create_time) + '</div>'
                content += '</div>'
                content += '</li>'
...
function dateFormat(value){
    ...
    var times=d.getFullYear() + '-' + (d.getMonth() + 1) + '-' + d.getDate() + ' ' + d.getHours() + ':' + (d.getMinutes()<10? '0' + d.getMinutes() : d.getMinutes()) + ':' + (d.getSeconds()<10? '0' + d.getSeconds() : d.getSeconds()); 
    return times
}